    ...
    <div className="min-h-screen bg-slate-950 px-4 py-12">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-10">
          ...
          <button
            onClick={logout}
            className="bg-red-500/10 hover:bg-red-500/20 active:bg-red-500/30 text-red-400 border border-red-500/20 hover:border-red-500/40 px-5 py-2 rounded-xl text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500/40 focus:ring-offset-2 focus:ring-offset-slate-950"
          >
            Logout
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 opacity-50 cursor-not-allowed">
            <div className="w-10 h-10 rounded-xl bg-slate-700/40 border border-slate-700 flex items-center justify-center mb-4">
